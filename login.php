...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($password_err)) {
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            window.location.href = "http://localhost/iteh-domaci/login.php";</script>';
            }
            $stmt->close();
        }
    }
        ...
        <div class="w3-third w3-container">
            <div id="formContent">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    ...
                    <p style="text-align:center; color:white">Nemaš nalog? <a href="register.php">Registruj se ovde</a>.</p>
                </form>
            </div>
        </div>
        <div class="w3-third w3-container">
